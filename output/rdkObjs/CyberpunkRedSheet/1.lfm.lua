...
local function constructNew_frmCyberpunkRedSheet1_svg()
    ...
    obj:beginUpdate();
    obj:setName("frmCyberpunkRedSheet1_svg");
    obj:setAlign("client");
    obj:setTheme("light");
...
function newfrmCyberpunkRedSheet1_svg()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmCyberpunkRedSheet1_svg();
      end,
      function()
...
local _frmCyberpunkRedSheet1_svg = {
    newEditor = newfrmCyberpunkRedSheet1_svg, 
    new = newfrmCyberpunkRedSheet1_svg, 
    name = "frmCyberpunkRedSheet1_svg", 
    dataType = "", 
    formType = "undefined", 
...
frmCyberpunkRedSheet1_svg = _frmCyberpunkRedSheet1_svg;
Firecast.registrarForm(_frmCyberpunkRedSheet1_svg);

return _frmCyberpunkRedSheet1_svg;
